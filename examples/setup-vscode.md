# Setting Up the Examples in Visual Studio Code
...
Install the **Scala (Metals)** extension from the VS Code marketplace.
Open `examples/scala-zio` in VS Code. Metals will import the sbt project automatically
...
<!-- VERIFY: Koka extension availability in VS Code's marketplace -->

Search for **Koka** in the VS Code extension marketplace. If unavailable, open the `.kk`
...
<!-- VERIFY: Flix extension availability in VS Code's marketplace -->

Search for **Flix** in the VS Code extension marketplace. The Flix compiler includes
